...
import mxchartutil.proxies.DataPoint;
import mxchartutil.proxies.MultiSeriesChart;
import mxchartutil.proxies.MultiSeriesDataset;
...
public class OQLChartDataset extends CustomJavaAction<IMendixObject>
{
	...
	public IMendixObject executeAction() throws Exception
	{
        ...
        while (iter.hasNext()) {
            ...
            logger.debug(String.format("Row: %s, %s, %s, %s, %s, %s, %d",
